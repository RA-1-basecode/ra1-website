...
if(isset($_POST['save'])) {
	...
	if(update_profile($_POST) > 0) {
		echo '<script>
				...
				document.location.href = "super_admin_profile";
			  </script>';
	} else {
...
<head>
	...
	<title>Super Admin Profile - Ra 1 Teknik Informatika UPG</title>
							...
							<div class="card">
								<div class="card-body">
									...
									<div class="text-center">
										<img src="foto-profile/6343c1d91c5f0.png" alt="My Photo Profile"  height="200" style="border-radius: 20px;">

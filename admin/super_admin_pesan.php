        ...
        <main class="content">
          ...
          <div class="row justify-content-center">
            <div class="col-md-10 col-sm-10 col-lg-10">
              <h3 class="mb-3">Pesan Kelas Ra 1</h3>
              <div class="card mt-3">
                                    ...
                                    <tbody>
                                        ...
                                        <?php foreach ($data as $row) : ?>
                                            <tr>
                                                ...
                                                <td><?= $row["subject"]; ?></td>
                                                <td><?= $row["menit"]; ?></td>
                                                <td><a href="hapus_pesan?id=<?= $row['id']; ?>" onclick="return confirm('Apakah yakin pesan ini akan dihapus?')" class="btn btn-danger btn-sm"><span data-feather="delete"></span></a>
                                                </td>
                                            <?php $i++; ?>
                                        <?php endforeach; ?>
                                    </tbody>
